      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit()}>
          <div className="flex flex-col gap-5">
              ...
              <FormField
                ...
                type="text"
                name="prompt"
                placeholder="A plush yellow robot sitting on a unicorn"
                value={form.prompt}
                handleChange={handleChange}
                isSurpriseMe
          ...
          <div className="mt-10">
              <p className="mt-2 text-[#666e75] text-[16px]">Once you have created the image you want, you can share it with others in the community</p>
